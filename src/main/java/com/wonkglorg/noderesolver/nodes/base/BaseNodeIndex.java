...
public enum BaseNodeIndex {
	ONE(BaseNodeIndex::setInput1, BaseNodeIndex::removeInput1),
	TWO(BaseNodeIndex::setInput2, BaseNodeIndex::removeInput2);

	private final BiConsumer<BaseMultiNode<?, ?, ?>, BaseNode> adder;
	private final BiConsumer<BaseMultiNode<?, ?, ?>, BaseNode> remover;

	BaseNodeIndex(BiConsumer<BaseMultiNode<?, ?, ?>, BaseNode> adder,
			BiConsumer<BaseMultiNode<?, ?, ?>, BaseNode> remover) {
		this.adder = adder;
